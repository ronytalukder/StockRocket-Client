...
import { CustomerDropDownApi, ProductDropDownApi, ReturnCreateApi } from "../API/ReturnApi";
import { useNavigate } from "react-router-dom";
import { useSelector } from "react-redux";
import { store } from "../store/store";
import { removeSelectedProductItems, resetForm, setFormValue, setSelectedProductItems } from "../slices/returnSlice";
...
const ReturnCreate = () => {
    ...
    let childBody = useSelector(state => state.return.selectedProductItems);
    console.log(childBody, parentBody)
...
const handleCretePurchase = async () => {
    ...
    let result = await ReturnCreateApi(parentBody, childBody);
    if (result) {
    ...
    <div className="mt-2">
        <div className="flex flex-col-reverse md:flex-row px-5 flex-wrap justify-between">
            ...
            <div className="w-full md:w-[25%]">
                <h1 className="text-3xl font-bold text-purple-500 mb-2 mt-2">Create Return</h1>
